class BigfootsShipwrecks_Config
{
	BS_debug_logCrateFill = 1; // 1 to log items spawned in crates to server .RPT, usually right after [Display #24]

	BS_player_showCrateClaimMessage = 1; // 1 to show toast and chat notification with coordinates to all players when any players are close to crate
	...
	BS_loot_enablePoptabs = 1; // 1 to spawn random number of poptabs in crates, otherwise false.
